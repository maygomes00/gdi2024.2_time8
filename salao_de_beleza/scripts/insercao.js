...
db.clientes.insertMany([
    ...
    { "nome": "Leo Lima", "telefone": "555-258", "aniversario": "14/02/1996" }
  ]);
...
db.profissionais.insertMany([
    ...
    { "nome": "Tomas", "disponibilidade": ["Segunda", "Quarta", "Quinta"], "servicos": ["Depilação - Axila", "Depilação - Pernas Inteiras", "Limpeza de Pele Completa"] },
